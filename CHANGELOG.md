...
* Добавлен модуль `panel-ui-kit`.
* Добавлена поддержка выбора темы (Light / Dark / System) прямо из шапки дебаг-панели.
* Добавлена поддержка Material You (dynamic colors) на Android 12+ — цвета подстраиваются под обои устройства.
* Полный редизайн основных плагинов.
* Добавлен KDoc к основным публичным сущностям.
